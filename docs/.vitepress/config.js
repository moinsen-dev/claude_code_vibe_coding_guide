...
export default defineConfig({
  ...
  description: 'A comprehensive guide to using Claude Code effectively in your development workflow',
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Effective Communication', link: '/best-practices/communication' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/your-username/claude-code-best-practices' }
    ],
    ...
    editLink: {
      pattern: 'https://github.com/your-username/claude-code-best-practices/edit/main/docs/:path',
      text: 'Edit this page on GitHub'
    }
  },

  base: '/claude_code_starter/',
